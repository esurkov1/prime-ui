    ...
    <PlaygroundDocPage
      ...
      description={
        <>
          ...
          составным; заголовки категорий раскрываются. В свёрнутом сайдбаре список плоский. Внизу
          сайдбара доступны глобальные настройки: переключатель light/dark и селектор из 10
