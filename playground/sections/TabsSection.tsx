...
export default function TabsSection() {
  return (
    <PageContent.Section>
      <PageContent.Header>
        <PageContent.Title>Tabs</PageContent.Title>
        <PageContent.Description measure="full">
          {
            <>
              Переключение между разделами на одной странице: сверху или сбоку список вкладок, ниже
              или рядом — содержимое выбранного раздела. Можно задать размер, вертикальный режим,
              отключить отдельные пункты и управлять активной вкладкой из кода.
            </>
          }
        ...
        <div className="demoExamples">
          ...
          <div className="demoBlock">
            ...
            <DemoDescription>
              ...
              не получает фокус в цикле стрелок, панель для него недоступна, пока вкладка неактивна
              по смыслу данных.
            </DemoDescription>
            <PlaygroundExampleFrame.Root
          ...
          <div className="demoBlock">
            ...
            <DemoDescription>
              Пара <code>value</code> и <code>onValueChange</code> на <code>Tabs.Root</code>:
              активная вкладка хранится в состоянии родителя (синхронизация с маршрутом, фильтром,
              шагом мастера).
            </DemoDescription>
          ...
          <div className="demoBlock">
            ...
            <DemoDescription>
              Отдельного пропа нет: корень и <code>Tabs.List</code> получают <code>className</code>{" "}
              с <code>w-full</code> / <code>min-w-0</code>, у <code>Tabs.Tab</code> —{" "}
          ...
          <div className="demoBlock">
            ...
            <DemoDescription>
              Обёртка с контекстом: хранит активный <code>value</code>, размер и ориентацию для
              списка и панелей.
            </DemoDescription>
