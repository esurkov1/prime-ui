    ...
    <PageContent.Section>
      <PageContent.Header>
        ...
        <PageContent.Description measure="full">
          {
            <>
              Боковая навигация: одна колонка <code>NavPanel</code>, масштаб <code>size</code>, на
              узком окне — оверлей и кнопка открытия.
            </>
          }
      ...
      <PageContent.Body>
        <div className="demoExamples">
          ...
          <div className="demoBlock">
            ...
            <DemoDescription>
              <code>sidebarSlot=&quot;page-nav&quot;</code> — колонка рядом с контентом (как в
              каркасе страницы).
            </DemoDescription>
          ...
          <div className="demoBlock">
            ...
            <DemoDescription>
              <code>IdentityButton</code> в шапке, <code>NavCategory</code> с{" "}
              <code>NavDocTree</code>, группы <code>Group</code> / <code>Menu</code>,{" "}
              <code>MenuAction</code> в строке пункта.
            </DemoDescription>
          ...
          <div className="demoBlock">
            ...
            <DemoDescription>
              ...
              оверлей отключается; при <code>true</code> (по умолчанию) на узком окне панель
              уезжает, остаётся подложка и кнопка открытия.
            </DemoDescription>
          ...
          <div className="demoBlock">
            ...
            <DemoDescription>
              <code>MenuButton asChild</code> с внешней ссылкой: стили остаются на дочернем
              элементе.
            </DemoDescription>
          ...
          <div className="demoBlock">
            ...
            <DemoDescription>
              Строка шапки: основной блок и при необходимости дополнительные действия; кнопка
              сворачивания встроена в <code>NavPanel</code>.
            </DemoDescription>
            ...
            <DemoDescription>
              По умолчанию не нужен: в <code>NavPanel</code> уже рендерится кнопка на грани (
              <code>placement=&quot;edge&quot;</code>
              ). Экспорт для редкого <code>inline</code> или отдельного экземпляра; состояние —
              через <code>Sidebar.Root</code> / <code>useSidebarContext</code>.
            </DemoDescription>
