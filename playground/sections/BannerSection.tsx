...
export default function BannerSection() {
  return (
    <PageContent.Section>
      <PageContent.Header>
        <PageContent.Title>Banner</PageContent.Title>
        <PageContent.Description measure="full">
          {
            <>
              ...
              заголовок, короткий текст и при необходимости кнопки; закрытие можно повесить на
              корень или вынести отдельную кнопку.
            </>
          }
        ...
        <div className="demoExamples">
          <div className="demoBlock">
            ...
            <DemoDescription>
              ...
              <code>status=&quot;information&quot;</code> — меняются отступы, кегль и размер иконки
              из одного яруса токенов.
            </DemoDescription>
          ...
          <div className="demoBlock">
            ...
            <DemoDescription>
              ...
              <code>lighter</code>, <code>stroke</code> на одном статусе <code>information</code>.
            </DemoDescription>
          ...
          <div className="demoBlock">
            ...
            <DemoDescription>
              ...
              объявление», внутри баннера — действие «Скрыть» без обязательного{" "}
              <code>onDismiss</code> на корне.
            </DemoDescription>
