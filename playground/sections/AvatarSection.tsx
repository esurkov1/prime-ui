    ...
    <PlaygroundDocPage
      ...
      description={
        <>
          ...
          <code>size</code> от <code>s</code> до <code>6xl</code>. Несколько аватаров можно собрать
          в <code>Avatar.Group.Root</code> с наложением и ячейкой <code>Avatar.Group.Overflow</code>{" "}
          для счётчика «ещё N».
        </>
      }
    >
