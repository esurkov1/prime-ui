...
import {
  ...
  type DataTableDividerStyle,
} from "@/components/data-table/DataTable";

import styles from "./divider-styles.module.css";
...
function DividerRow({ divider }: { divider: DataTableDividerStyle }) {
  return (
    <>
      <p className={styles.label}>divider = {divider}</p>
      <DataTable.Root
...
export default function DataTableDividerStylesSnippet() {
  return (
    <>
